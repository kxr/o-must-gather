...
map = [
    ...
    },
    {
        ...
        "aliases": ["certificatesigningrequests", "csr"],
        "need_ns": False,
        "get_func": from_yaml,
        "getout_func": csr_out,
    ...
    },
    {
        ...
        "need_ns": True,
        "get_func": from_yaml,
        "getout_func": deployment_out,
        "yaml_loc": "namespaces/%s/apps/deployments.yaml",
    },
    {
        "type": "deploymentconfig",
        "aliases": ["deploymentconfigs", "dc"],
        "need_ns": True,
        "get_func": from_yaml,
        "getout_func": dc_out,
    ...
    },
    {
        ...
        "aliases": ["horizontalpodautoscalers", "hpa"],
        "need_ns": True,
        "get_func": from_yaml,
        "getout_func": hpa_out,
    ...
    },
    {
        ...
        "aliases": ["machineconfigpools", "mcp"],
        "need_ns": False,
        "get_func": from_yaml,
        "getout_func": mcp_out,
    ...
    },
    {
        ...
        "aliases": ["persistentvolumeclaims", "pvc"],
        "need_ns": True,
        "get_func": from_yaml,
        "getout_func": pvc_out,
    ...
    },
    {
        ...
        "aliases": ["projects"],
        "need_ns": False,
        "get_func": get_project,
        "getout_func": project_out,
    ...
    },
    {
        ...
        "aliases": ["replicationcontrollers", "rc"],
        "need_ns": True,
        "get_func": from_yaml,
        "getout_func": rc_out,
    ...
    },
    {
        ...
        "aliases": ["validatingwebhookconfigurations"],
        "need_ns": False,
        "get_func": from_yaml,
        "getout_func": vwhc_out,
...
def map_res(t):
    if t is not None:
        for x in map:
            ...
            if t.lower() == x["type"].lower() or t.lower() in [
                y.lower() for y in x["aliases"]
            ]:
                return x
        ...
        try:
            ...
            for c in crds:
                ...
                if t.lower() == singular or t.lower() in aliases:
                    ...
                    mg_path = Config().path
                    res_dict["yaml_loc"] = os.path.join(
                        mg_path, yaml_pre, group, plural
                    )
